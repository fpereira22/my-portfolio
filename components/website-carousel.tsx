...
function WebsiteCarouselComponent() {
    ...
    const websitesData = [
        ...
        {
            slug: "litestartsup",
            url: "https://litestartsup.sppa.cl/",
            imageSrc: "/img/websites/previews/litestartsup-preview.webp",
            logoSrc: "/img/websites/litestartsup.png",
            borderClass: "border-violet-500 hover:border-violet-400",
            shadowClass: "hover:shadow-violet-500/30",
            gradientClass: "from-violet-900/90",
            textClass: "text-violet-300",
            descColorClass: "text-violet-200",
            tags: ["React", "Next.js", "Three.js", "3D"],
            tagBgClass: "bg-violet-500/20 border-violet-400/30"
        },
        {
            slug: "ssgl",
