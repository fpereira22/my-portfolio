...
const translations = {
  es: {
    ...
    "websites.roadwise.desc": "Plataforma de tecnología de vanguardia para el análisis y monitoreo de carreteras mediante Inteligencia Artificial. Desarrollada para SSGL, implementa Computer Vision y Machine Learning para la detección automática de infraestructura vial.",
    "websites.ssgl.title": "SSGL.CL",
    "websites.ssgl.desc": "Sitio corporativo para Sociedad de Servicios Generales Ltda., empresa líder en mantención vial.",
    ...
    "websites.manuel.desc": "Sitio de marca personal, fotografía profesional y edición artística.",
  ...
  en: {
    ...
    "websites.roadwise.title": "ROADWISE.CL",
    "websites.roadwise.desc": "Cutting-edge technology platform for road analysis and monitoring using Artificial Intelligence. Developed for SSGL, it implements Computer Vision and Machine Learning for automatic detection of road infrastructure.",
    "websites.ssgl.title": "SSGL.CL",
    "websites.ssgl.desc": "Corporate website for Sociedad de Servicios Generales Ltda., a leading company in road maintenance.",
    "websites.sppa.title": "SPPA.CL",
    ...
    "websites.manuel.desc": "Personal branding site, professional photography and artistic editing.",
  ...
  eu: {
    ...
    "websites.roadwise.title": "ROADWISE.CL",
    "websites.roadwise.desc": "Adimen Artifiziala erabiliz errepideen analisi eta jarraipen plataforma aurreratua. SSGLrentzat garatua, Computer Vision eta Machine Learning inplementatzen ditu bide azpiegituren detekzio automatikorako.",
    "websites.ssgl.title": "SSGL.CL",
    "websites.ssgl.desc": "Sociedad de Servicios Generales Ltda.-ren webgune korporatiboa, bide mantentze sektorearen enpresa liderra.",
    "websites.sppa.title": "SPPA.CL",
    ...
    "websites.manuel.desc": "Marka pertsonaleko webgunea, argazkigintza profesionala eta edizio artistikoa.",
